    ...
    <section className="benefits max-w-6xl mx-auto py-12 md:px-8 px-4 xl:px-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-7 gap-y-8">
        <div className="item-card bg-white rounded-2xl p-7 gap-y-7 flex flex-col">
          ...
          >
            <path
              d="M32.0292 27.6V16.2917C32.0292 15.2375 31.1667 14.375 30.1125 14.375H24.5541"
              stroke="#640EF1"
              strokeWidth={3}
              strokeLinecap="round"
            ...
            />
            <path
              d="M27.4292 11.5L23.9792 14.375L27.4292 17.25"
              stroke="#640EF1"
              strokeWidth={3}
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <div>
            <h3 className="font-semibold text-xl mb-2   ">Extra Cashback</h3>
            <p className="text-base leading-lg text-gray-500">
              Making your experience exelent
            </p>
          </div>
        ...
        <div className="item-card bg-white rounded-2xl p-7 gap-y-7 flex flex-col">
          ...
          <div>
            <h3 className="font-semibold text-xl mb-2   ">Safety package</h3>
            <p className="text-base leading-lg text-gray-500">
              Don't worry to your package book
            </p>
          </div>
          <a href="#" className="text-violet-700 font-semibold">
            Learn More
        ...
        <div className="item-card bg-[#080C2E] relative rounded-2xl p-7 gap-y-7 flex flex-col">
          ...
          <div className="z-10 gap-y-7 flex flex-col">
            ...
            <div>
              ...
              <p className="text-base leading-lg text-white">
                Decide the community based on latest reports
              </p>
            </div>
        ...
        <div className="item-card bg-white rounded-2xl p-7 gap-y-7 flex flex-col">
          ...
          <div>
            ...
            <p className="text-base leading-lg text-gray-500">
              Have a long access without worrying any loss
            </p>
          </div>
          <a href="#" className="text-violet-700 font-semibold">
            Learn More
